...
* 函数功能：处理KEY1按下的事件，即KEY1按键按下的响应函数 
* 输入参数：void
* 输出参数：void
* 返 回 值：void
* 完成日期：2021年07月01日
...
/*********************************************************************************************************
* 函数名称：ProcKeyUpKey1
* 函数功能：处理KEY1弹起的事件，即KEY1按键弹起的响应函数 
* 输入参数：void
* 输出参数：void
* 返 回 值：void
* 完成日期：2021年07月01日
...
* 函数功能：处理KEY2按下的事件，即KEY2按键按下的响应函数 
* 输入参数：void
* 输出参数：void
* 返 回 值：void
* 完成日期：2021年07月01日
...
/*********************************************************************************************************
* 函数名称：ProcKeyUpKey2
* 函数功能：处理KEY2弹起的事件，即KEY2按键弹起的响应函数 
* 输入参数：void
* 输出参数：void
* 返 回 值：void
* 完成日期：2021年07月01日
...
* 函数功能：处理KEY3按下的事件，即KEY3按键按下的响应函数 
* 输入参数：void
* 输出参数：void
* 返 回 值：void
* 完成日期：2021年07月01日
...
/*********************************************************************************************************
* 函数名称：ProcKeyUpKey3
* 函数功能：处理KEY3弹起的事件，即KEY3按键弹起的响应函数 
* 输入参数：void
* 输出参数：void
* 返 回 值：void
* 完成日期：2021年07月01日
