...
static  void  ProcSPO2Task(void);   //SPO2处理任务
...
{ 
  ...
  {
    printf("GD32F310 SPO2 Project - Running\r\n");
...
* 注    意：处理血氧数据生成和发送
*********************************************************************************************************/
static  void  ProcSPO2Task(void)
{ 
  static u8 modeCounter = 0;
  
  ProcessUARTSPO2();  // 处理SPO2任务
  ...
  if(Get1SecFlag())
  {
    ...
    if(modeCounter >= 5)
    {
      ...
      /* 循环切换工作模式 */
      EnumSPO2Mode currentMode = GetSPO2Mode();
      switch(currentMode)
      {
        case SPO2_MODE_IDLE:
          SetSPO2Mode(SPO2_MODE_CONTINUOUS);
          printf("SPO2 Mode: Continuous\r\n");
          break;
        case SPO2_MODE_CONTINUOUS:
          SetSPO2Mode(SPO2_MODE_TEST);
          printf("SPO2 Mode: Test\r\n");
          break;
        case SPO2_MODE_TEST:
          SetSPO2Mode(SPO2_MODE_SINGLE);
          printf("SPO2 Mode: Single\r\n");
          break;
        case SPO2_MODE_SINGLE:
        default:
          SetSPO2Mode(SPO2_MODE_IDLE);
          printf("SPO2 Mode: Idle\r\n");
          break;
      }
    }
  }
